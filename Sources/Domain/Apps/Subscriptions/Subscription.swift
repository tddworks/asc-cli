...
extension Subscription: AffordanceProviding {
    public var structuredAffordances: [Affordance] {
        var items: [Affordance] = [
            ...
            Affordance(key: "createOfferCode", command: "subscription-offer-codes", action: "create",
                       params: ["subscription-id": id,
                                "name": "<name>",
                                "duration": "<ONE_MONTH|THREE_MONTHS|SIX_MONTHS|ONE_YEAR>",
                                "mode": "<FREE_TRIAL|PAY_AS_YOU_GO|PAY_UP_FRONT>",
                                "periods": "<n>",
                                "eligibility": "<NEW|LAPSED|WIN_BACK|PAID_SUBSCRIBER>",
            ...
            Affordance(key: "getReviewScreenshot", command: "subscription-review-screenshot", action: "get",
                       params: ["subscription-id": id]),
            Affordance(key: "uploadReviewScreenshot", command: "subscription-review-screenshot", action: "upload",
                       params: ["subscription-id": id, "file": "<path>"]),
            Affordance(key: "listImages", command: "subscription-images", action: "list",
                       params: ["subscription-id": id]),
            Affordance(key: "uploadImage", command: "subscription-images", action: "upload",
                       params: ["subscription-id": id, "file": "<path>"]),
