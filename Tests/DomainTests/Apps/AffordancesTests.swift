...
struct AffordancesTests {
    ...
    // MARK: - CustomerReview affordances

    @Test func `customer review affordances include getResponse respond and listReviews`() {
    ...
    // MARK: - CustomerReviewResponse affordances

    @Test func `customer review response affordances include delete and getReview`() {
